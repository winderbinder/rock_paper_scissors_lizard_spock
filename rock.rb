loop do
  ...
  while !(player_input == "rock" || player_input == "paper" || player_input == "scissors" || player_input == "lizard" || player_input == "spock" || player_input == "potato")
    puts "that weapon does not exist in this world!"
    puts "pick one of 5 weapons that i have brought upon you!"
    player_input = gets.chomp.strip
  end

  if player_input == "rock" || player_input == "paper" || player_input == "scissors" || player_input == "lizard" || player_input == "spock"
    if player_input == computer_player
      ...
      puts "player chose #{player_input} and computer player chose #{computer_player} computer player won!"
    end
  end
